...
router.post('/create-request', (0, auth_1.default)(user_1.USER_ROLES.USER), (0, validateRequest_1.default)(request_validation_1.RequestValidations.requestZodSchema), request_controller_1.RequestController.createRequest);
